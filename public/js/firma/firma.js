...
function firmarComprobante(mi_contenido_p12, mi_pwd_p12, comprobante) {
    ...
    var datosSubject= cert.subject.attributes.map(da => [{'valor':da.value, 'shortName':da.shortName}]);
    var cnSign='';
    var lSign='';
    var ouSign='';
    var oSign='';
                ...
                SignedProperties += '<etsi:Cert>';
                    ...
                    SignedProperties += '<etsi:IssuerSerial>';
                        SignedProperties += '<ds:X509IssuerName>';
                            SignedProperties += `CN=${cnSign},L=${lSign},OU=${ouSign},O=${oSign},C=${cSign}`;
                        SignedProperties += '</ds:X509IssuerName>';
